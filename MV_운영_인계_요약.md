...
3. `MV_수동리허설_기록지.md`: 실제 화면 리허설 기록
4. `MV_운영전_리허설_체크리스트.md`: 실제 사용자 프로젝트 점검 절차
5. `MV_테스트_실행_가이드.md`: 자동 테스트 보호 범위
6. `MV_실제프로젝트_리허설_결과.md`: 샘플/실제 프로젝트 리허설 준비 결과
7. `MV_개선작업_이력.md`: 날짜별 개선 이력
