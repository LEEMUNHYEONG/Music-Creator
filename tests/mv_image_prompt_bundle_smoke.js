...
assert.ok(bundleText.includes("=== MV 최종 품질 체크리스트 ==="));
assert.ok(bundleText.includes("내보내기 판정: 확인 필요"));
assert.ok(bundleText.includes("전체 씬: 2개"));
assert.ok(bundleText.includes("- 카메라: 확인 필요 1개"));
