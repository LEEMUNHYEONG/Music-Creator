    ...
    const evaluation = await cdp.send("Runtime.evaluate", {
      ...
      expression: `(() => {
        const names = [
          ...
          "markGeminiTemporarilyDisabled",
          "isGeminiTemporarilyDisabled",
          "handleGeminiApiFailure",
          "buildMarketingMVDiagnostics",
          "buildMarketingMVSceneDiagnostics",
          "compareMarketingMVDiagnostics",
          "formatMarketingMVDiagnosticsComparison",
          "logMarketingMVSaveComparison",
          "buildCurrentMarketingMVRehearsalReport",
          "openMarketingMVDiagnosticsModal",
          "closeMarketingMVDiagnosticsModal",
          "copyCurrentMarketingMVDiagnosticsReport",
          "focusFirstMarketingMVDiagnosticsScene",
          "showMarketingMVDiagnostics",
          "downloadMarketingMVRehearsalReport",
